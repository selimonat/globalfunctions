function [mvar]=error_ellipse(data,varargin)
%[scale]=error_ellipse(data,varargin)
...
% data = [y1 y2];
%
% MVAR is average of the two eigenvalues, proportional to the area of the
% ellipsis
...
mvar = (smallest_eigenval(1) + largest_eigenval(1))/2;
